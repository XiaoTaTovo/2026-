...
static const PitchAxisVelocityTestConfig pitch_velocity_test_config = {
    ...
    /* Reduce the tilt generated by large outer-loop demands. */
    .automatic_tilt_scale_um_per_outer_rpm = 130U,
    .automatic_tilt_limit_um = 6000U,
...
static const PitchAxisVisionConfig pitch_vision_config = {
    ...
    /* Hardware testing showed the actuator needs a learned neutral tilt to
     * cancel the fixed mechanical bias before position error can reach zero. */
    .kp_rpm_per_mm = 0.30f,
    .ki_rpm_per_mm_s = 0.02f,
    .kd_rpm_per_mm_s = 0.12f,
...
int main(void)
{
  ...
  while (1)
  {
    ...
    {
      PitchStatusDisplay_Service(&pitch_status_display, now_ms);
    }
  }
  /* USER CODE END 3 */
}
